...
export default function DriveBar({ label, usedBytes, totalBytes, usedPercent }: DriveBarProps) {
  return (
    <div className="flex items-center justify-between py-[3px]">
      <span className="text-[10px] text-text-tertiary min-w-[85px] font-mono font-light">{label}</span>
      ...
      <span className="text-[10px] text-text-tertiary font-mono min-w-[48px] text-right font-light">
